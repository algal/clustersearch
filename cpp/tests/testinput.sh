../build/clusters --verbose=0 --alpha=2 --length=8 --colors=3 --seed=1
../build/clusters --verbose=0 --alpha=2 --length=8 --colors=3 --seed=2
../build/clusters --verbose=0 --alpha=2 --length=8 --colors=3 --seed=3
...
../build/clusters --verbose=0 --alpha=3 --length=8 --colors=4 --seed=6 --samples=50 --mode=data --pdf=0.3,0.2,0.25,0.25
